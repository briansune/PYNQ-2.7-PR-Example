; ModuleID = 'G:/20220610_zynq/pynq_pr_example/pynq_pr_ip/pynq_pr_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_pr_add_ir(%"class.hls::stream"* %stream_in, %"class.hls::stream"* %stream_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_pr_add_hw(%"class.hls::stream"* %stream_in_copy, %"class.hls::stream"* %stream_out_copy)
...
declare void @apatb_pr_add_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @pr_add_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @pr_add_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @pr_add_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
