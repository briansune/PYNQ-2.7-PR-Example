...
extern "C" void pr_sub(__cosim_sC__*, __cosim_sC__*);
extern "C" void apatb_pr_sub_hw(volatile void * __xlx_apatb_param_stream_in, volatile void * __xlx_apatb_param_stream_out) {
  ...
  __cosim_sC__* __xlx_stream_out_input_buffer= new __cosim_sC__[ap_apatb_stream_out_V_cap_bc];
  // DUT call
  pr_sub(__xlx_stream_in_input_buffer, __xlx_stream_out_input_buffer);
  for (unsigned i = 0; i <ap_apatb_stream_out_V_cap_bc; ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_stream_out)->write(__xlx_stream_out_input_buffer[i]);
}
