; ModuleID = 'G:/20220610_zynq/pynq_pr_example/pynq_pr_ip/pynq_pr_ip2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %struct.qdma_axis }
%struct.qdma_axis = type { %struct.ap_uint, %struct.ap_uint.0, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3 }
...
define void @apatb_pr_sub_ir(%"class.hls::stream"* %stream_in, %"class.hls::stream"* %stream_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_pr_sub_hw(%"class.hls::stream"* %stream_in_copy, %"class.hls::stream"* %stream_out_copy)
...
declare void @apatb_pr_sub_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @pr_sub_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @pr_sub_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @pr_sub_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
